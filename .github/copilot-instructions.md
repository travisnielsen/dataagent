...
6. **Branch naming compliance**: Before any `git switch -c` or `git branch -m`, enforce [CONTRIBUTING.md](../CONTRIBUTING.md) branch policy. Accepted patterns: `<type>/<short-description>`, `<type>/<ticket>-<short-description>`, `docs/<short-description>`, or Spec Kit native (`NNN-<short-description>` / `YYYYMMDD-HHMMSS-<short-description>`). Do not reprefix Spec Kit branches.
